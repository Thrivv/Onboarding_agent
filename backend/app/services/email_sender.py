                ...
                <div class="content">
                    ...
                    <div class="action-box">
                        ...
                        <ul style="margin: 10px 0; padding-left: 20px;">
                            ...
                            <li style="margin: 8px 0;">Ensure all text is visible and readable</li>
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="error-box">
                        <h3 style="margin: 0 0 15px 0; color: #e65100;">Issue Details</h3>
            ...
            <div class="content">
                ...
                <div class="timeline">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ...
                        <li style="padding: 10px 0; border-bottom: 1px solid #dee2e6;">
                            <strong>Step 2:</strong> Account activation within <strong>3-4 business days</strong>
                        </li>
