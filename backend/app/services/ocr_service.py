    ...
    try:
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            ...
            if doc_type == "commercial":
                ...
                english_data, arabic_data, managers, partners = extractor.extract_with_ai(raw_text)
                validation_result = extractor.validate_extraction(english_data, arabic_data, managers, partners)
                ...
                analysis = {
                    ...
                    "status_message": "✅ VALID: Commercial License extracted" if validation_result["is_valid"] else f"❌ INCOMPLETE: {', '.join(validation_result.get('issues', []))}",
