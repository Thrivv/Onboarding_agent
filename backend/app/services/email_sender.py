...
FROM_EMAIL = os.getenv("FROM_EMAIL", "noreply@thrivv.com")

def send_email(to_email: str, subject: str, body_html: str) -> bool:
    """Generic email sender function"""
    try:
        msg = MIMEMultipart("alternative")
        msg["From"] = formataddr(("Thrivv Banking", FROM_EMAIL))
        msg["To"] = to_email
        msg["Subject"] = subject
...
def send_welcome_email(to_email: str, user_name: str, account_type: str) -> bool:
    """
    Send welcome email after successful signup
    """
    subject = "Welcome to Thrivv Banking! 🎉"
    
    # Determine required documents based on account type
    if account_type == "Savings":
        docs_needed = "Emirates ID (EID) and Ejari (Tenancy Contract)"
    elif account_type == "Corporate":
        docs_needed = "Commercial License, Emirates ID, and other business documents"
    else:
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>🏦 Welcome to Thrivv Banking!</h1>
            </div>
            <div class="content">
                <h2>Hello {user_name},</h2>
                
                <p>Thank you for choosing Thrivv Banking! We're excited to have you on board.</p>
                ...
                <ol>
                    ...
                    <li><strong>Upload your documents:</strong> {docs_needed}</li>
                    <li><strong>Complete verification</strong> - our team will review within 3-4 business days</li>
                    <li><strong>Start banking!</strong> Once approved, you'll receive your account details</li>
                </ol>
                ...
                <div class="info-box">
                    <strong>💡 Pro Tip:</strong> Have all your documents ready before starting the upload process for a smoother experience!
                </div>
                
                <p>If you have any questions, feel free to reach out to our support team.</p>
                
                <p>Best regards,<br>
                <strong>The Thrivv Banking Team</strong></p>
            </div>
            
            <div class="footer">
                <p>This is an automated message from Thrivv Banking.</p>
                <p>© 2024 Thrivv Banking. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
