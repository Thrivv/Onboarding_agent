...
def send_onboarding_complete_email(to_email: str, user_name: str):
    ...
    subject = "ðŸŽ‰ Onboarding Complete - Account Activation Pending"
...
def generate_welcome_message(email: str, user_data: dict, doc_status: dict, stage: str, 
    ...
    if is_complete:
        return f"Welcome back, {name}! ðŸŽ‰ All your documents have been verified. Your account will be activated within 3-4 business days."
...
async def upload_conversational(
    ...
    if not result["success"] or result["document_type"] == "unknown":
        ...
        try:
            ...
            print(f"[WARN] ⚠️ âš ï¸ Failed to send error email: {email_error}")
            import traceback
            traceback.print_exc()
